...
interface Props {
  relationDeviceList: RelationDevice[];
}
...
const RelationDeviceComponent = (props: Props) => {
  const deviceList = props.relationDeviceList;
  return (
...
export default RelationDeviceComponent;
